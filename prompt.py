...
instr_narr01 = '这是篇新的记叙文作文,作为一个中学语文教师,认真理解作文的各个段落,并指出作文在人物刻画方面的不足之处.满分10分请打分'
instr_narr02 = '这是篇新的记叙文作文,作为一个中学语文教师,认真理解作文的各个段落,并指出作文在情感描写方面的不足之处.满分10分请打分'
instr_narr03 = '这是篇新的记叙文作文,作为一个中学语文教师,认真理解作文的各个段落,并指出作文在故事叙述方面的不足之处.满分10分请打分'
instr_narr04 = '这是篇新的记叙文作文,作为一个中学语文教师,认真理解作文的各个段落,并指出作文在语言运用方面的不足之处.满分10分请打分'
...
instr_argu01 = '这是篇新的议论文作文,作为一个中学语文教师,认真理解作文的各个段落,指出作文在逻辑结构上的不足之处.满分10分请打分'
instr_argu02 = '这是篇新的议论文作文,作为一个中学语文教师,认真理解作文的各个段落,指出作文在举例论证上的不足之处,如论据与论点不紧密相关,举例不够具体详实,没有深入分析论据与论点的内在联系.满分10分请打分'
instr_argu03 = '这是篇新的议论文作文,作为一个中学语文教师,认真理解作文的各个段落,指出作文在结论提炼上的不足之处.满分10分请打分'
instr_argu04 = '这是篇新的议论文作文,作为一个中学语文教师,认真理解作文的各个段落,指出个段落之间的衔接不合逻辑或衔接生硬不自然的地方.满分10分请打分'
instr_argu05 = '这是篇新的议论文作文,作为一个中学语文教师,认真理解作文的各个段落,指出作文在语言运用方面的不准确不生动不流畅,突兀或生硬之处.满分10分请打分'
